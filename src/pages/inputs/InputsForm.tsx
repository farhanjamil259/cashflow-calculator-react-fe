...
const InputsForm = () => {
  ...
  const [
    nonEmploymentDefinedContributionPensionPlans,
    setNonEmploymentDefinedContributionPensionPlans,
  ] = useState<INonEmploymentDefinedContributionPensionPlan[]>([
    {
      original_balance: 0,
      annual_contribution: 0,
    },
  ...
  const [IndividualSavingsAccountDrawdowns, setIndividualSavingsAccountDrawdowns] = useState<
    IIndividualSavingAccountDrawdowns[]
  >([
    {
      owner_name: "",
  ...
  const [pensionIncomeDefinedBenifitPensionPlans, setPensionIncomeDefinedBenifitPensionPlans] = useState<
    IPensionIncomeDefinedBenifitPensionPlan[]
  >([
    {
  ...
  const [
    ...
    setPensionIncomeDefinedContributionPensionPlans,
  ] = useState<IPensionIncomeDefinedContributionPensionPlans[]>([
    {
      option_taken: "Lump Sum",
        ...
        <Row>
          ...
          <Col xl={16} lg={24} md={24} sm={24} xs={24}>
            ...
            <People
              ...
              onOwnerAdd={(
                clone: any,
                savingsAndInvestmentsClone: any,
                nonEmploymentDefinedContributionPensionPlansClone: any
              ) => {
                setOwners(clone);
                setNonEmploymentDefinedContributionPensionPlans(
                  nonEmploymentDefinedContributionPensionPlansClone
                );
                ...
                const clone3: INonEmploymentDefinedContributionPensionPlan[] = [
                  ...nonEmploymentDefinedContributionPensionPlans,
                ];
                ...
                const clone9: IPensionIncomeDefinedBenifitPensionPlan[] = [
                ...
                const clone10: IPensionIncomeDefinedContributionPensionPlans[] = [
                  ...pensionIncomeDefinedContributionPensionPlans,
                ];
                clone10.push({
                  option_taken: "Lump Sum",
