...
import {
  IDividendIncome,
  IEmploymentIncome,
  IIndividualSavingAccountDrawdowns,
  IOwner,
...
const Income = (props: any) => {
  ...
  const selfEmploymentIncome: ISelfEmploymentIncome[] = props.selfEmploymentIncome;
  ...
  const pensionIncomeDefinedContributionPensionPlans: IPensionIncomeDefinedContributionPensionPlans[] =
    props.pensionIncomeDefinedContributionPensionPlans;
  ...
  return (
    <Card title="Income" id="income" style={{ margin: "16px", borderColor: "#81c784" }}>
      ...
      {selfEmploymentIncome.map((income: any, i: number) => {
        return (
          <Row key={i + "selfemploymentincome"}>
            <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
              <Form.Item label=" ">
                <Text
                  strong
              ...
              <Form.Item label="Share of income:">
                <InputNumber
                  ...
                  onBlur={(e) => {
                    ...
                    clone.details[i].share_of_rental_income = +e.target.value.replace("%", "") / 100;
                ...
                <Form.Item label=" ">
                  <Text>
                    ...
                    <Button
                      type="link"
                      onClick={() => {
                        const clone: IIndividualSavingAccountDrawdowns[] = [
                          ...savingsAndInvestmentsDrawdowns.individual_savings_accounts,
                        ];
                    ...
                    <Form.Item label="Drawdown:">
                      <InputNumber
                        ...
                        onBlur={(e) => {
                          ...
                          clone[i].drawdowns[i2].amount_to_drawn_down = +e.target.value.replace(
                            /£\s?|(,*)/g,
                            ""
                          );
      ...
      {pensionIncomeDefinedBenifitPensionPlans.map((plan: any, i: number) => {
        return (
          <Row key={i + "pensionIncomeDefinedBenifitPensionPlans"}>
            <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
              <Form.Item label=" ">
                <Text
                  strong
            ...
            <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
              <Form.Item label="Option taken:">
                <Select
                  ...
                  className="custom-input-fields"
                  onChange={(e) => {
                    const clone: IPensionIncomeDefinedBenifitPensionPlan[] = [
                      ...pensionIncomeDefinedBenifitPensionPlans,
                    ];
              ...
              <Form.Item label="Annual increase">
                <InputNumber
                  ...
                  onBlur={(e) => {
                    ...
                    clone[i].annual_increase = +e.target.value.replace("%", "") / 100;
      ...
      {pensionIncomeDefinedContributionPensionPlans.map((plan: any, i: number) => {
        return (
          <Row key={i + "pensionIncomeDefinedContributionPensionPlans"}>
            <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
              <Form.Item label=" ">
                <Text
                  strong
            ...
            <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
              <Form.Item label="Option taken:">
                <Select
                  ...
                  className="custom-input-fields"
                  onChange={(e) => {
                    const clone: IPensionIncomeDefinedContributionPensionPlans[] = [
                      ...pensionIncomeDefinedContributionPensionPlans,
                    ];
