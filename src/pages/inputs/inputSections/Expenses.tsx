    ...
    return (
        <Card title="Expenses" id="expenses" style={{margin: "16px", borderColor: "#e57373"}}>
            ...
            <Row>
                ...
                <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
                    <Form.Item label=" ">
                        <InputNumber value={housingTotal}
                                     formatter={value => `$ ${value}`.replace(/\B(?=(\d{3})+(?!\d))/g, ',')} disabled
                                     className="custom-input-fields"/>
                    </Form.Item>
                </Col>
            </Row>
            ...
            <Row>
                ...
                <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
                    <Form.Item label=" ">
                        <InputNumber value={consumablesTotal}
                                     formatter={value => `$ ${value}`.replace(/\B(?=(\d{3})+(?!\d))/g, ',')} disabled
                                     className="custom-input-fields"/>
                    </Form.Item>
                </Col>
            ...
            {shopping.map((expense: any, i: number) => {
                return <Row key={i + "shopping"}>
                    <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
                        <Form.Item label="Expense:">
                            <Input
                                placeholder="Clothing and Accessories" onBlur={(e) => {
                                const clone: IExpenseDetails[] = [...shopping];
                                clone[i].name = e.target.value;
            ...
            <Row>
                ...
                <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
                    <Form.Item label=" ">
                        <InputNumber value={shoppingTotal}
                                     formatter={value => `$ ${value}`.replace(/\B(?=(\d{3})+(?!\d))/g, ',')} disabled
                                     className="custom-input-fields"/>
                    </Form.Item>
                </Col>
            ...
            {entertainment.map((expense: any, i: number) => {
                return <Row key={i + "entertainment"}>
                    <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
                        <Form.Item label="Expense:">
                            <Input placeholder="Drinks" onBlur={(e) => {
                                const clone: IExpenseDetails[] = [...entertainment];
                                clone[i].name = e.target.value;
            ...
            <Row>
                ...
                <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
                    <Form.Item label=" ">
                        <InputNumber value={entertainmentTotal}
                                     formatter={value => `$ ${value}`.replace(/\B(?=(\d{3})+(?!\d))/g, ',')} disabled
                                     className="custom-input-fields"/>
                    </Form.Item>
                </Col>
            ...
            {holiday.map((expense: any, i: number) => {
                return <Row key={i + "holiday"}>
                    <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
                        <Form.Item label="Expense:">
                            <Input placeholder="Flights" onBlur={(e) => {
                                const clone: IExpenseDetails[] = [...holiday];
                                clone[i].name = e.target.value;
            ...
            <Row>
                ...
                <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
                    <Form.Item label=" ">
                        <InputNumber value={holidayTotal}
                                     formatter={value => `$ ${value}`.replace(/\B(?=(\d{3})+(?!\d))/g, ',')} disabled
                                     className="custom-input-fields"/>
                    </Form.Item>
                </Col>
            ...
            <Row>
                <Col lg={6} md={6} sm={24} xs={24} className="custom-input-fields">
                    <Form.Item label=" ">
                        <Text>Life Insurance <Text strong>{owners[0].name}</Text></Text>
                    </Form.Item>
                </Col>
                <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
                    <Form.Item label="Annual Expense:">
            ...
            {owners.length > 1 && <Row>
                <Col lg={6} md={6} sm={24} xs={24} className="custom-input-fields">
                    <Form.Item label=" ">
                        <Text>Life Insurance <Text strong>{owners[1].name}</Text></Text>
                    </Form.Item>
                </Col>
                <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
                    <Form.Item label="Annual Expense:">
            ...
            <Row>
                <Col lg={6} md={6} sm={24} xs={24} className="custom-input-fields">
                    <Form.Item label=" ">
                        <Text>Critical Illness Cover <Text strong>{owners[0].name}</Text></Text>
                    </Form.Item>
                </Col>
                <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
                    <Form.Item label="Annual Expense:">
            ...
            {owners.length > 1 && <Row>
                <Col lg={6} md={6} sm={24} xs={24} className="custom-input-fields">
                    <Form.Item label=" ">
                        <Text>Critical Illness Cover <Text strong>{owners[1].name}</Text></Text>
                    </Form.Item>
                </Col>
                <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
                    <Form.Item label="Annual Expense:">
            ...
            <Row>
                <Col lg={6} md={6} sm={24} xs={24} className="custom-input-fields">
                    <Form.Item label=" ">
                        <Text>Family Income Benifit <Text strong>{owners[0].name}</Text></Text>
                    </Form.Item>
                </Col>
                <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
                    <Form.Item label="Annual Expense:">
            ...
            {owners.length > 1 && <Row>
                <Col lg={6} md={6} sm={24} xs={24} className="custom-input-fields">
                    <Form.Item label=" ">
                        <Text>Family Income Benifit <Text strong>{owners[1].name}</Text></Text>
                    </Form.Item>
                </Col>
                <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
                    <Form.Item label="Annual Expense:">
            ...
            {oneOffExpenses.map((expense: any, i: number) => {
                return <Row key={i + "oneOffExpenses"}>
                    <Col lg={4} md={4} sm={24} xs={24} className="custom-input-fields">
                        <Form.Item label="Expense:">
                            <Input placeholder="Main House Renovation"
                                   onBlur={(e) => {
                                       const clone: IOneOffExpenses[] = [...oneOffExpenses];
                                       clone[i].name = e.target.value;
