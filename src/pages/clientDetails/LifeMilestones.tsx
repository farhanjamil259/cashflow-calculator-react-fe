...
import {Card, Col, Row, Table, Typography, Progress, Button, Modal, Form, Input, DatePicker, Select} from "antd";
...
function LifeMilestones() {
    ...
    return <Layout style={{backgroundColor: "white"}}>
        ...
        <Row>
            <Col span={12}>
                <Card title="Goals" bordered={false} extra={<Button type="primary" style={{marginBottom: 16}} onClick={()=>{
            ...
            <Col span={12}>
                <Card title="Events" bordered={false} extra={<Button type="primary" style={{marginBottom: 16}} onClick={()=>{
