        ...
        <Layout>
          ...
          <Content>
            <Switch>
              ...
              <Route
                exact
                path={"/dashboard/clientDashboard/clientPlanDetails/lifeMilestones"}
                component={LifeMilestones}
              />
              <Route
                exact
                path={"/dashboard/clientDashboard/clientPlanDetails"}
                component={HouseholdDetails}
              />
              <Route
                exact
                path={"/dashboard/clientDashboard/clientPlanDetails/cashflow"}
                component={Cashflow}
              />
              <Route
                exact
                path={"/dashboard/clientDashboard/clientPlanDetails/assetsAndLiabilities"}
                component={AssetsAndLiabilities}
              />
              <Route
                exact
                path={"/dashboard/clientDashboard/clientPlanDetails/incomeBreakdown"}
