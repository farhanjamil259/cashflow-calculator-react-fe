...
const CalcRealSummary = (summary: IForecastSummary[], assumptions: IAssumptions) => {
    ...
    const realSummary: IForecastSummary[] = summary.map((s, i) => {
        const realFormula = (val: number) => {
            ...
            newVal = val * (1 / ((1 + Math.max(assumptions.market_data.retain_price_index.rate, assumptions.market_data.consumer_price_index.rate)) ** (i)))
        ...
        return {
            ...
            assets_and_liabilities_analysis: {
                ...
                total_savings_and_investments: realFormula(s.assets_and_liabilities_analysis.total_savings_and_investments),
            ...
            income_analysis: {
                ...
                total_savings_and_investments_drawdowns: realFormula(s.income_analysis.total_savings_and_investments_drawdowns),
            ...
            tax_and_expenses_as_a_percentage_of_income: {
                tax_and_expenses_as_a_percentage_of_income: s.tax_and_expenses_as_a_percentage_of_income.tax_and_expenses_as_a_percentage_of_income,
            },
            property_analysis: {
